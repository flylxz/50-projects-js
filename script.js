const projects = [
  {
    ...
    imgLink: '01-expanding-cards.png',
  },
  {
    number: 2,
    name: '02-progress-steps',
    imgLink: '02-progress-steps.png',
  },
  {
    number: 3,
    name: '03-rotating-navigation-animation',
    imgLink: '03-rotating-navigation-animation.png',
  },
  {
    number: 4,
    name: '04-hidden-search-widget',
    imgLink: '04-hidden-search-widget.png',
  },
  {
    number: 5,
    name: '05-blurry-loading',
    imgLink: '05-blurry-loading.png',
  },
  {
    number: 6,
    name: '06-scroll-animation',
    imgLink: '06-scroll-animation.png',
  },
  {
    number: 7,
    name: '07-split-landing-page',
    imgLink: '07-split-landing-page.png',
  },
  { number: 8, name: '08-form-wave', imgLink: '08-form-wave.png' },
  { number: 9, name: '09-sound-board', imgLink: '09-sound-board.png' },
  { number: 10, name: '10-dad-jokes', imgLink: '10-dad-jokes.png' },
  {
    number: 11,
    name: 'event-keycodes',
